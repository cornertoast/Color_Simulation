...
class Cell_Spectrum(QWidget):
    ...
    def __init__(self):
        ...
        self.Cell_Spectrum_button_layout = QGridLayout()
        self.Cell_Spectrum_button_layout.addWidget(self.import_data_button, 0, 0)
        self.Cell_Spectrum_button_layout.addWidget(self.export_data_button, 0, 1)
        self.Cell_Spectrum_button_layout.addWidget(self.Form_clear_button, 0, 2)
        self.Cell_Spectrum_button_layout.addWidget(self.create_data_button, 1, 0)
        self.Cell_Spectrum_button_layout.addWidget(self.table_delete_button, 1, 1)
        self.Cell_Spectrum_button_layout.addWidget(self.select_db_table, 1, 2)
        self.Cell_Spectrum_button_layout.addWidget(self.add_column_button, 2, 0)
        self.Cell_Spectrum_button_layout.addWidget(self.delete_column_button, 2, 1)
        self.Cell_Spectrum_button_layout.addWidget(self.delete_select_column_button, 2, 2)
        self.Cell_Spectrum_button_layout.addWidget(self.save_table_button, 3, 0)
        self.Cell_Spectrum_button_layout.addWidget(self.insert_column_button, 3, 1)
        self.Cell_Spectrum_button_layout.addWidget(self.paste_button, 3, 2)
        self.Cell_Spectrum_button_layout.addWidget(self.table, 4, 0, 1, 3)

        self.setLayout(self.Cell_Spectrum_button_layout)
